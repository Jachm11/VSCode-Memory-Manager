...
<title>Heap Visualizer: regexpp</title>
...
<div class="contents">
<div class="textblock"><p><a href="https://www.npmjs.com/package/regexpp"><object type="image/svg+xml" data="https://img.shields.io/npm/v/regexpp.svg" style="pointer-events: none;">npm version</object></a> <a href="http://www.npmtrends.com/regexpp"><object type="image/svg+xml" data="https://img.shields.io/npm/dm/regexpp.svg" style="pointer-events: none;">Downloads/month</object></a> <a href="https://travis-ci.org/mysticatea/regexpp"><object type="image/svg+xml" data="https://travis-ci.org/mysticatea/regexpp.svg?branch=master" style="pointer-events: none;">Build Status</object></a> <a href="https://coveralls.io/github/mysticatea/regexpp"><object type="image/svg+xml" data="https://coveralls.io/repos/github/mysticatea/regexpp/badge.svg" style="pointer-events: none;">Coverage Status</object></a> <a href="https://david-dm.org/mysticatea/regexpp"><object type="image/svg+xml" data="https://david-dm.org/mysticatea/regexpp.svg" style="pointer-events: none;">Dependency Status</object></a></p>
...
</div><!-- fragment --><h2>parseRegExpLiteral(source, options?)</h2>
...
<h2>validateRegExpLiteral(source, options?)</h2>
...
<h2>visitRegExpAST(ast, handlers)</h2>
...
<h2>RegExpParser</h2>
<h3>new RegExpParser(options?)</h3>
<ul>
<li><b>Parameters:</b><ul>
<li><code>options?</code> (<a href="src/parser.ts#L539"><code>RegExpParser.Options</code></a>) The options to parse.</li>
</ul>
...
<h3>parser.parseLiteral(source, start?, end?)</h3>
...
<h3>parser.parsePattern(source, start?, end?, uFlag?)</h3>
...
<h3>parser.parseFlags(source, start?, end?)</h3>
...
<h2>RegExpValidator</h2>
<h3>new RegExpValidator(options)</h3>
<ul>
<li><b>Parameters:</b><ul>
<li><code>options</code> (<a href="src/validator.ts#L127"><code>RegExpValidator.Options</code></a>) The options to validate.</li>
</ul>
...
<h3>validator.validateLiteral(source, start, end)</h3>
...
<h3>validator.validatePattern(source, start, end, uFlag)</h3>
...
<h3>validator.validateFlags(source, start, end)</h3>
...
<h2>RegExpVisitor</h2>
<h3>new RegExpVisitor(handlers)</h3>
<ul>
<li><b>Parameters:</b><ul>
<li><code>handlers</code> (<a href="src/visitor.ts#L204"><code>RegExpVisitor.Handlers</code></a>) The callbacks.</li>
</ul>
