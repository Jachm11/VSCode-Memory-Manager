...
<title>Heap Visualizer: minimatch</title>
...
<h2>minimatch(path, pattern, options)</h2>
...
</div><!-- fragment --><h2>minimatch.filter(pattern, options)</h2>
...
</div><!-- fragment --><h2>minimatch.match(list, pattern, options)</h2>
...
</div><!-- fragment --><h2>minimatch.makeRe(pattern, options)</h2>
...
<h1>Comparisons to other fnmatch/glob implementations</h1>
