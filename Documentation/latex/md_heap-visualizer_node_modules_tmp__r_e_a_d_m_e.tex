...
\href{https://travis-ci.org/raszi/node-tmp}{\texttt{ }} \href{https://david-dm.org/raszi/node-tmp}{\texttt{ }} \href{https://badge.fury.io/js/tmp}{\texttt{ }} \href{https://raszi.github.io/node-tmp/}{\texttt{ }} \href{https://snyk.io/test/npm/tmp}{\texttt{ }}
...
Tmp offers both an asynchronous and a synchronous A\+PI. For all A\+PI calls, all the parameters are optional. There also exists a promisified version of the A\+PI, see (5) under references below.
...
Please also check \href{https://raszi.github.io/node-tmp/}{\texttt{ A\+PI docs}}.

\doxysubsection*{Asynchronous file creation}
...
\doxysubsection*{Synchronous file creation}
...
\doxysubsection*{Asynchronous directory creation}
...
\doxysubsection*{Synchronous directory creation}
...
\doxysubsection*{Asynchronous filename generation}
...
\doxysubsection*{Synchronous filename generation}
...
\doxysubsection*{Controlling the Descriptor}
...
\doxysubsection*{mkstemp like, asynchronously}
...
\doxysubsection*{mkstemp like, synchronously}
