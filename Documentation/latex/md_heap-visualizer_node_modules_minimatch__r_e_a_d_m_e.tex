...
\doxysubsection*{minimatch(path, pattern, options)}
...
\doxysubsection*{minimatch.\+filter(pattern, options)}
...
\doxysubsection*{minimatch.\+match(list, pattern, options)}
...
\doxysubsection*{minimatch.\+make\+Re(pattern, options)}
