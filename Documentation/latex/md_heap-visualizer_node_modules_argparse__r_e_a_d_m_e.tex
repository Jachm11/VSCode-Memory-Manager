...
C\+LI arguments parser for node.\+js. Javascript port of python\textquotesingle{}s \href{http://docs.python.org/dev/library/argparse.html}{\texttt{ argparse}} module (original version 3.\+2). That\textquotesingle{}s a full port, except some very rare options, recorded in issue tracker.
...
\item Use {\ttfamily argparse.\+Const.\+R\+E\+M\+A\+I\+N\+D\+ER} instead of {\ttfamily argparse.\+R\+E\+M\+A\+I\+N\+D\+ER}, and similarly for constant values {\ttfamily O\+P\+T\+I\+O\+N\+AL}, {\ttfamily Z\+E\+R\+O\+\_\+\+O\+R\+\_\+\+M\+O\+RE}, and {\ttfamily O\+N\+E\+\_\+\+O\+R\+\_\+\+M\+O\+RE} (aliases for {\ttfamily nargs} values `'?\textquotesingle{}{\ttfamily ,}\textquotesingle{}$\ast$\textquotesingle{}{\ttfamily ,}\textquotesingle{}+\textquotesingle{}{\ttfamily , respectively), and }S\+U\+P\+P\+R\+E\+S\+S\`{}.
\end{DoxyItemize}
...
More \href{https://github.com/nodeca/argparse/tree/master/examples}{\texttt{ examples}}.

\doxysection*{Argument\+Parser objects }
...
Details in \href{http://docs.python.org/dev/library/argparse.html\#argumentparser-objects}{\texttt{ original Argument\+Parser guide}}

\doxysection*{add\+Argument() method }
...
Details in \href{http://docs.python.org/dev/library/argparse.html\#the-add-argument-method}{\texttt{ original add\+\_\+argument guide}}

\doxysection*{Action (some details) }
...
Details in \href{http://docs.python.org/dev/library/argparse.html\#action}{\texttt{ original action guide}}

\doxysection*{Sub-\/commands }
...
Details in \href{http://docs.python.org/dev/library/argparse.html\#sub-commands}{\texttt{ original sub-\/commands guide}}
...
\href{https://github.com/nodeca/argparse/graphs/contributors}{\texttt{ others}}

\doxysection*{License }

Copyright (c) 2012 \href{https://github.com/puzrin}{\texttt{ Vitaly Puzrin}}. Released under the M\+IT license. See \href{https://github.com/nodeca/argparse/blob/master/LICENSE}{\texttt{ L\+I\+C\+E\+N\+SE}} for details. 