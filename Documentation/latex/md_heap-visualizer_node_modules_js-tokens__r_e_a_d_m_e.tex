...
\doxysubsubsection*{{\ttfamily js\+Tokens}}
...
\doxysubsubsection*{{\ttfamily var token = match\+To\+Token(match)}}
...
Names are E\+C\+M\+A\+Script Identifier\+Names, that is, including both identifiers and keywords. You may use \href{https://github.com/crissdev/is-keyword-js}{\texttt{ is-\/keyword-\/js}} to tell them apart.

Whitespace includes both line terminators and other whitespace.

\doxysection*{E\+C\+M\+A\+Script support }

The intention is to always support the latest E\+C\+M\+A\+Script version whose feature set has been finalized.

If adding support for a newer version requires changes, a new version with a major verion bump will be released.

Currently, E\+C\+M\+A\+Script 2018 is supported.

\doxysection*{Invalid code handling }
...
Invalid non-\/\+A\+S\+C\+II characters are treated as names, to simplify the matching of names (except unicode spaces which are treated as whitespace). Note\+: See also the \href{\#es2018}{\texttt{ E\+S2018}} section.
...
\doxysection*{Limitations }

Tokenizing Java\+Script using regexes—in fact, \+\_\+one single regex\+\_\+—won’t be perfect. But that’s not the point either.

You may compare js\+Tokens with \href{http://esprima.org/}{\texttt{ esprima}} by using {\ttfamily esprima-\/compare.\+js}. See {\ttfamily npm run esprima-\/compare}!

\doxysubsubsection*{Template string interpolation}
...
\doxysubsubsection*{Division and regex literals collision}
...
\doxysubsubsection*{E\+S2018}

E\+S2018 added some nice regex improvements to the language.


\begin{DoxyItemize}
\item \href{http://2ality.com/2017/07/regexp-unicode-property-escapes.html}{\texttt{ Unicode property escapes}} should allow telling names and invalid non-\/\+A\+S\+C\+II characters apart without blowing up the regex size.
...
These things would be nice to do, but are not critical. They probably have to wait until the oldest maintained Node.\+js L\+TS release supports those features.
