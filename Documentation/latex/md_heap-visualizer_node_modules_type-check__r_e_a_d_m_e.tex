...
Check out the \href{\#syntax}{\texttt{ type syntax format}} and \href{\#guide}{\texttt{ guide}}.
...
\doxysubsection*{type\+Check(type, input, options)}

{\ttfamily type\+Check} checks a Java\+Script value {\ttfamily input} against {\ttfamily type} written in the \href{\#type-format}{\texttt{ type format}} (and taking account the optional {\ttfamily options}) and returns whether the {\ttfamily input} matches the {\ttfamily type}.

\doxyparagraph*{arguments}


\begin{DoxyItemize}
\item type -\/ {\ttfamily String} -\/ the type written in the \href{\#type-format}{\texttt{ type format}} which to check against
\item input -\/ {\ttfamily $\ast$} -\/ any Java\+Script value, which is to be checked against the type
\item options -\/ {\ttfamily Maybe Object} -\/ an optional parameter specifying additional options, currently the only available option is specifying \href{\#custom-types}{\texttt{ custom types}}
\end{DoxyItemize}
...
\doxysubsection*{parse\+Type(type)}

{\ttfamily parse\+Type} parses string {\ttfamily type} written in the \href{\#type-format}{\texttt{ type format}} into an object representing the parsed type.

\doxyparagraph*{arguments}


\begin{DoxyItemize}
\item type -\/ {\ttfamily String} -\/ the type written in the \href{\#type-format}{\texttt{ type format}} which to parse
\end{DoxyItemize}
...
\doxysubsection*{parsed\+Type\+Check(parsed\+Type, input, options)}
...
\label{_type-format}%
 \doxysection*{Type Format}

\doxysubsection*{Syntax}
