...
The \href{http://en.wikipedia.org/wiki/Rm_(Unix)}{\texttt{ U\+N\+IX command}} {\ttfamily rm -\/rf} for node.
...
If you repeatedly encounter {\ttfamily E\+M\+F\+I\+LE} errors, then consider using \href{http://npm.im/graceful-fs}{\texttt{ graceful-\/fs}} in your program.
