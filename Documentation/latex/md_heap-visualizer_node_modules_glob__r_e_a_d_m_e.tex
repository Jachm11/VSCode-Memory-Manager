...
\doxysubsection*{Basename Matching}
...
\doxysection*{glob.\+has\+Magic(pattern, \mbox{[}options\mbox{]})}
...
\doxysection*{glob(pattern, \mbox{[}options\mbox{]}, cb)}
...
\doxysection*{glob.\+sync(pattern, \mbox{[}options\mbox{]})}
...
\doxysubsection*{new glob.\+Glob(pattern, \mbox{[}options\mbox{]}, \mbox{[}cb\mbox{]})}
...
\doxysection*{Comparisons to other fnmatch/glob implementations}
...
\doxysubsection*{Comments and Negation}
...
The logo is licensed under a \href{https://creativecommons.org/licenses/by-sa/4.0/}{\texttt{ Creative Commons Attribution-\/\+Share\+Alike 4.\+0 International License}}.
