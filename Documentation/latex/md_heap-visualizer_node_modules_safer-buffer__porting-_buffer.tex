...
\doxysubsection*{Finding problematic bits of code using grep}
...
\doxysubsection*{Finding problematic bits of code using Node.\+js 8}
...
\doxysubsection*{Finding problematic bits of code using linters}
...
\label{_variant-1}%
 \doxysection*{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}
...
\label{_variant-2}%
 \doxysection*{Variant 2\+: Use a polyfill}
...
\doxysubsection*{Buffer(not\+Number)}
...
\doxysection*{Regarding Buffer.\+alloc\+Unsafe}
...
\label{_design-flaws}%
 \doxysubsection*{What is wrong with the {\ttfamily Buffer} constructor?}
...
\label{_ecosystem-usage}%
 \doxysubsection*{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}
