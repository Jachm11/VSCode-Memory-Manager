...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.

\doxysection*{Do I need it?}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.

\doxysection*{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}
...
\doxysection*{But isn\textquotesingle{}t throwing bad?}
...
\doxysubsection*{Would it affect third-\/party modules?}
...
\doxysubsection*{But I don\textquotesingle{}t want throwing…}
