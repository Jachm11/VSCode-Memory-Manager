...
\href{\#about}{\texttt{ About}} \textperiodcentered{} \href{\#usage}{\texttt{ Usage}} \textperiodcentered{} \href{\#settings-format}{\texttt{ Settings Format}} \textperiodcentered{} \href{\#argument-format}{\texttt{ Argument Format}}
...
M\+IT license. Version 0.\+8.\+3 \begin{DoxyVerb}npm install optionator
\end{DoxyVerb}
...
\doxysubsection*{parse(input, parse\+Options)}
...
\doxysubsection*{parse\+Argv(input)}
...
\doxysubsection*{generate\+Help(help\+Options)}
...
\doxysubsection*{generate\+Help\+For\+Option(option\+Name)}
...
\doxysubsection*{Top Level Properties}
...
\doxysubsubsection*{Heading Properties}
...
\doxysubsubsection*{Option Properties}
...
\doxysubsubsection*{Help Style Properties}
