...
\item \href{https://github.com/eslint/eslint/commit/8233873b8e5facd80ab7b172bff1e896a9c5fd39}{\texttt{ {\ttfamily 8233873}}} Docs\+: Add note about Node.\+js requiring S\+SL support (fixes \#11413) (\#12475) (Nicholas C. Zakas)
...
\item \href{https://github.com/eslint/eslint/commit/561093fc4267a4ae317d63bc9f103020fad88802}{\texttt{ {\ttfamily 561093f}}} Upgrade\+: bump inquirer to $^\wedge$7.0.\+0 (\#12440) (Joe Graham)
...
\begin{DoxyItemize}
\item \href{https://github.com/eslint/eslint/commit/0e0b784b922051c2a1d39dd8160382114b645800}{\texttt{ {\ttfamily 0e0b784}}} Upgrade\+: espree@$^\wedge$6.1.\+1 (\#12158) (Kevin Partington)
...
\item \href{https://github.com/eslint/eslint/commit/915676022a100ae5dba788fa3329d34b3c1f18d3}{\texttt{ {\ttfamily 9156760}}} Sponsors\+: Sync R\+E\+A\+D\+ME with website (E\+S\+Lint Jenkins)
...
\begin{DoxyItemize}
\item \href{https://github.com/eslint/eslint/commit/8f86ccaa89daf10123370868c5dcb48c1fcbef7d}{\texttt{ {\ttfamily 8f86cca}}} Upgrade\+: eslint-\/scope@$^\wedge$5.0.\+0 (\#12011) (Kevin Partington)
...
\item \href{https://github.com/eslint/eslint/commit/3396c3e2231b5b6e16da8751c22c86c256590f6b}{\texttt{ {\ttfamily 3396c3e}}} Upgrade\+: karma@$^\wedge$4.0.\+1, drops \mbox{\hyperlink{class_node}{Node}} 6 support, fixes vulnerability (\#11570) (Kevin Partington)
...
\item \href{https://github.com/eslint/eslint/commit/6693161978a83e0730d5ea0fecdb627c5a2acdfd}{\texttt{ {\ttfamily 6693161}}} Sponsors\+: Sync R\+E\+A\+D\+ME with website (E\+S\+Lint Jenkins)
...
\item \href{https://github.com/eslint/eslint/commit/64895185bde5233223648bcaf46f8deb72c9fb55}{\texttt{ {\ttfamily 6489518}}} Fix\+: no-\/extra-\/parens crash when code is \char`\"{}((let))\char`\"{} (\#11444) (Teddy Katz)
...
\item \href{https://github.com/eslint/eslint/commit/5018378131fd5190bbccca902c0cf4276ee1581a}{\texttt{ {\ttfamily 5018378}}} Chore\+: enable require-\/unicode-\/regexp on E\+S\+Lint codebase (\#11422) (Teddy Katz)
...
\item 7765fc4 Upgrade\+: ajv@$^\wedge$6.0.\+1, still using json schema draft 04 (\#9856) (Kevin Partington)
...
\item 7d6e052 Upgrade\+: esquery@$^\wedge$1.0.\+1 (fixes \#8733) (\#10170) (Kevin Partington)
...
\begin{DoxyItemize}
\item 6b71fd0 Fix\+: table@4.\+0.\+2, because 4.\+0.\+3 needs \char`\"{}ajv\char`\"{}\+: \char`\"{}$^\wedge$6.\+0.\+1\char`\"{} (\#10022) (Mathieu Seiler)
...
\item 4ddc131 Upgrade\+: debug@$^\wedge$3.1.\+0 (\#9731) (Kevin Partington)
...
\begin{DoxyItemize}
\item 1e362a0 Revert \char`\"{}\+Fix\+: Use X\+M\+L 1.\+1 on X\+M\+L formatters (fixes \#9607) (\#9608)\char`\"{} (\#9667) (Kevin Partington)
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item 76dab18 Upgrade\+: doctrine@$^\wedge$2.0.\+2 (\#9656) (Kevin Partington)
...
\item 208fb0f Fix\+: Use X\+ML 1.\+1 on X\+ML formatters (fixes \#9607) (\#9608) (Daniel Reigada)
...
\item 6a333ff Upgrade\+: espree@$^\wedge$3.4.\+2 (\#8526) (Kevin Partington)
...
\item f987814 Docs\+: Update C\+H\+A\+N\+G\+E\+L\+O\+G.\+md for v4.\+0.\+0-\/alpha.\+1 release (\#8488) (Kai Cataldo)
\end{DoxyItemize}
...
\item a78ec9f Chore\+: upgrade {\ttfamily coveralls} to $^\wedge$2.11.\+16 (\#8161) (alberto)
...
\item 3493241 Upgrade\+: strip-\/json-\/comments $\sim$v2.0.\+1 (Janus Troelsen)
...
\item fe0d903 Upgrade\+: Shelljs to $^\wedge$0.7.\+5 (fixes \#7316) (\#7465) (Gyandeep Singh)
...
\begin{DoxyItemize}
\item b467436 Upgrade\+: Upgrade Espree to 3.\+3.\+1 (\#7253) (Ilya Volodin)
...
\item 35f7be9 Upgrade\+: espree to 3.\+2.\+0, remove tests with Syntax\+Errors (fixes \#7169) (\#7170) (Teddy Katz)
...
\item dfbc112 Upgrade\+: proxyquire to 1.\+7.\+10 (fixes \#6821) (\#6822) (alberto)
...
\begin{DoxyItemize}
\item 510ce4b Upgrade\+: file-\/entry-\/cache@$^\wedge$1.3.\+1 (fixes \#6816, refs \#6780) (\#6819) (alberto)
...
\begin{DoxyItemize}
\item 2438ee2 Upgrade\+: Update markdownlint dependency to 0.\+2.\+0 (fixes \#6781) (\#6782) (David Anson)
...
\begin{DoxyItemize}
\item 565e584 Fix\+: {\ttfamily eslint\+:all} causes regression in 3.\+1.\+0 (fixes \#6687) (\#6696) (alberto)
...
\item e42cacb Upgrade\+: mock-\/fs to 3.\+10, fixes for \mbox{\hyperlink{class_node}{Node}} 6.\+3 (fixes \#6621) (\#6624) (Tim Schaub)
...
\item 10c3e91 Docs\+: Remove reference from 3.\+0.\+0 migration guide (refs \#6605) (\#6618) (Kevin Partington)
...
\item 666da7c Docs\+: 3.\+0.\+0 migration guide (\#6521) (Nicholas C. Zakas)
...
\item 777941e Upgrade\+: doctrine to 1.\+2.\+2 (fixes \#6121) (\#6231) (alberto)
...
\item dc538aa Build\+: Pin proxyquire to \char`\"{}$>$=1.\+0.\+0 $<$1.\+7.\+5\char`\"{} (fixes \#6096) (\#6100) (alberto)
...
\item 23b00e0 Upgrade\+: npm-\/license to 0.\+3.\+2 (fixes \#5996) (\#5998) (alberto)
\item 377167d Upgrade\+: ignore to 3.\+1.\+2 (fixes \#5979) (\#5988) (alberto)
...
\item 25d626a Upgrade\+: espree 3.\+1.\+4 (fixes \#5923, fixes \#5756) (Kai Cataldo)
...
\item a4ae769 Docs\+: Manual changelog update for v2.\+5.\+1 (Nicholas C. Zakas)
...
\item 83cd651 Upgrade\+: chai to 3.\+5.\+0 (fixes \#5647) (alberto)
...
\item 1f47868 Docs\+: Update yield-\/star-\/spacing documentation for 2.\+0.\+0 (fixes \#5272) (Burak Yigit Kaya)
...
\item 1651ffa Docs\+: update migrating to 2.\+0.\+0 (fixes \#5232) (Toru Nagashima)
...
\item e0c5cf7 Upgrade\+: Espree to 3.\+0.\+0 (fixes \#5018) (Ilya Volodin)
...
\item 8ac1dac Build\+: Update markdownlint dependency to 0.\+1.\+0 (fixes \#4988) (David Anson)
...
\item 7b632f8 Upgrade\+: Globals to $^\wedge$8.18.\+0 (fixes \#4728) (Gyandeep Singh)
...
\item 688f277 Fix\+: Set proper exit code for \mbox{\hyperlink{class_node}{Node}} $>$ 0.\+10 (fixes \#4691) (Nicholas C. Zakas)
